<?php
	...
	if(isset($login))
	{
		$que=mysqli_query($conn,"select * from admin where user='$email' and nm='$pass'");
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Please Enter the details</h3>
                    </div>
                    <div class="panel-body">
                        <form method="post">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Nick name" name="pass" type="text" required>
                                </div>
                                
                                
								<div class="form-group">
                                    <input name="login" type="submit" value="Forget password" class="btn btn-lg btn-success btn-block">
                                </div>
